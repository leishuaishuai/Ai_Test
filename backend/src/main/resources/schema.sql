...
CREATE TABLE IF NOT EXISTS `user_points` (
    ...
    `type` TINYINT NOT NULL COMMENT '类型：1-学习奖励，2-成就奖励，3-签到奖励，4-其他',
