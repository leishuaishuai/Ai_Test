...
-- 成就数据（完整的成就徽章定义）
-- -----------------------------------------------------
-- type: 1-学习时长(分钟)，2-课时完成，3-单词掌握，4-连续打卡，5-课程完成
INSERT INTO `achievement` (`id`, `title`, `description`, `icon`, `type`, `condition_value`, `condition_unit`, `points`, `sort_order`, `status`) VALUES
-- 学习时长成就
(1, '初学者', '累计学习时长达到30分钟', '⏰', 1, 30, '分钟', 10, 1, 1),
(2, '勤奋学员', '累计学习时长达到1小时', '📚', 1, 60, '分钟', 20, 2, 1),
(3, '学习达人', '累计学习时长达到5小时', '🎯', 1, 300, '分钟', 50, 3, 1),
(4, '学习狂人', '累计学习时长达到10小时', '🔥', 1, 600, '分钟', 80, 4, 1),
(5, '学霸', '累计学习时长达到50小时', '🏆', 1, 3000, '分钟', 200, 5, 1),
-- 课时完成成就
(6, '初学入门', '完成第一节课的学习', '📖', 2, 1, '节课', 10, 6, 1),
(7, '课程探索者', '完成5节课的学习', '🔍', 2, 5, '节课', 30, 7, 1),
(8, '课时达人', '完成20节课的学习', '🎓', 2, 20, '节课', 80, 8, 1),
-- 课程完成成就（一门课程包含多个课时）
(9, '课程大师', '完成一门完整课程', '🌟', 5, 1, '门课程', 200, 9, 1),
(10, '全能学霸', '完成3门完整课程', '👑', 5, 3, '门课程', 500, 10, 1),
-- 单词掌握成就
(11, '词汇新手', '掌握10个单词', '📝', 3, 10, '个单词', 10, 11, 1),
(12, '词汇积累者', '掌握50个单词', '📖', 3, 50, '个单词', 30, 12, 1),
(13, '词汇达人', '掌握100个单词', '📚', 3, 100, '个单词', 100, 13, 1),
(14, '词汇专家', '掌握300个单词', '🏆', 3, 300, '个单词', 200, 14, 1),
(15, '词汇大师', '掌握500个单词', '👑', 3, 500, '个单词', 500, 15, 1),
-- 连续打卡成就
(16, '打卡新手', '连续打卡3天', '📅', 4, 3, '天', 20, 16, 1),
(17, '坚持不懈', '连续打卡7天', '🔥', 4, 7, '天', 50, 17, 1),
(18, '持之以恒', '连续打卡15天', '💪', 4, 15, '天', 100, 18, 1),
(19, '打卡达人', '连续打卡30天', '🌟', 4, 30, '天', 200, 19, 1),
(20, '打卡王者', '连续打卡100天', '👑', 4, 100, '天', 500, 20, 1);
